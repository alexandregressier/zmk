...
static const struct led_rgb LAYER_COLORS[8] = {
    LED_RGB(0x000000), LED_RGB(0x00FFFF), LED_RGB(0xFF0000), LED_RGB(0x0000FF),  // K C R B
    LED_RGB(0xFFFFFF), LED_RGB(0x00FF00), LED_RGB(0xFFFF00), LED_RGB(0xFF00FF)}; // W G Y M
